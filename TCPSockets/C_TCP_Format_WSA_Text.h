...
//    File name: C_TCP_Format_WSA_Text.h
...
const unsigned int MAX_WSA_ERROR_TEXT = 80;

class C_TCP_Format_WSA_Text
{
public:
   C_TCP_Format_WSA_Text( );
   ~C_TCP_Format_WSA_Text();
   void Format_WSA_Error_As_Text( int wsa_error, char *wsa_text );
};